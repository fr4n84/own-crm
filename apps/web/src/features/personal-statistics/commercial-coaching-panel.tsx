...
export function CoachingReviewList({ analyses, onReview }: { analyses: readonly Analysis[]; onReview: (id: string, decision: "confirmed" | "discarded") => void }) {
  if (analyses.length === 0) return <Empty heading="Sin análisis de coaching" description="Los borradores aparecen al solicitar análisis desde una grabación o una videollamada de Google Meet." />;
