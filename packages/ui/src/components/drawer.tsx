      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            "[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:h-dvh data-[swipe-axis=x]:max-h-dvh data-[swipe-axis=x]:[--drawer-content-width:100%] data-[swipe-axis=y]:[--drawer-content-max-height:calc(100dvh-6rem)] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:100dvh] data-[swipe-axis=x]:sm:[--drawer-content-width:24rem]",
            // Stack.
